...
module challenge::day_21 {
    ...
    #[test]
    public fun test_planting_increases_counter(){
        let mut scenario = test_scenario::begin(@0x3);
    ...
    #[test]
    public fun test_harvesting_increases_counter(){
        let mut scenario = test_scenario::begin(@0x3);
    ...
    #[test]
    public fun test_multiple_operations(){
        let mut scenario = test_scenario::begin(@0x3);
    ...
    public fun test_invalid_plot_id_zero(){
        let mut scenario = test_scenario::begin(@0x3);
    ...
    public fun test_duplicate_plot(){
        let mut scenario = test_scenario::begin(@0x3);
        ...
        plant_on_farm(&mut farm, 1);
        plant_on_farm(&mut farm, 1); //try again
